...
public class FileController {
    ...
    @PostMapping("/upload")
    public String upload(@RequestParam MultipartFile file, @RequestParam Boolean isAvatar) throws IOException {
        ...
        File parentFile = new File(fileUploadPath + fileUUID);
    ...
    public Result findPage(@RequestParam Integer pageNum,
        ...
        queryWrapper.eq("is_avatar", false);
